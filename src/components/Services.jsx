...
const ICON_MAP = {
  ...
  Flutter: { slug: 'flutter', color: '47C5FB' },
...
function SocialIcons() {
  return (
    <div className="social-media">
      <a
        href="https://www.instagram.com/lethean.seourn/"
        target="_blank"
      ...
      <a
        href="https://t.me/Lethean_Seourn"
        target="_blank"
        rel="noopener noreferrer"
        aria-label="Telegram"
      >
      ...
      <div className="svc-flip">
        <div className="svc-face svc-front">
          ...
          <div className="bottom-section">
            <span className="title">{s.backTitle}</span>
            <div className="row">
        ...
        {/* Back face — travel-card style */}
        <div className="svc-face svc-back">
          <div className="bk-row">
            <div className="bk-pill bk-pill-tag">
              <span className="bk-pill-icon" aria-hidden="true">●</span>
              <span>{s.subtitle}</span>
            </div>
            <div className="bk-actions">
              <div className="bk-pill bk-pill-drop">
          ...
          <div className="bk-text">
            <h3 className="bk-title">{s.title}</h3>
            <p className="bk-desc">{s.desc}</p>
          </div>

          <div className="bk-thumbs" aria-hidden="true">
            <div className="bk-thumb bk-thumb-1" />
            <div className="bk-thumb bk-thumb-2" />
          </div>

          <div className="bk-dots" aria-hidden="true">
            {Array.from({ length: total }).map((_, i) => (
              <span key={i} className={`bk-dot ${i === idx ? 'is-active' : ''}`} />
            ))}
          </div>
        </div>
      </div>
    ...
    <section id="services" className="section">
      <div className="container">
        ...
        <div className="svc-grid">
          {items.map((s, idx) => (
            <ServiceCard key={s.title} s={s} idx={idx} total={items.length} />
          ))}
        </div>
      </div>
    </section>
