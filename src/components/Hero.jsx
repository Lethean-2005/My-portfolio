      ...
      <div className="container hero-nolana-grid">
        <div className="hero-nolana-left">
          <div className="creators-pill hero-anim">
            ...
            <span className="creators-text">227+ Happy Creators</span>
          </div>

          <h1 className="hero-title hero-title-nolana hero-anim">
            <span className="title-accent">{t.hero.title1}</span> the future of
            <br />
            product development
          </h1>

          <p className="hero-desc hero-desc-mono hero-anim">
            Develop software features with
            <br />
